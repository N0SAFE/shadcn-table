...
export function createFilterTypeDef<
  ComponentProps extends BaseFilterProps,
  Operator extends FilterOperatorDef
>(
  operators: readonly Operator[],
  options: {
    defaultOperator: Operator["value"];
    defaultValue?: NoInfer<
      ComponentProps extends BaseFilterProps<infer T, any> ? T : never
    >;
  ...
  ComponentProps extends BaseFilterProps<infer T, any> ? T : never,
  ComponentProps extends BaseFilterProps<any, infer M> ? M : never,
  ComponentProps,
  Operator
> {
  return {
...
export function createAdapter<
  Meta = any,
  AdapterValue extends Record<
    string,
    FilterTypeDef<any, any, any, any>
  > = Record<string, FilterTypeDef<any, any, any, any>>
